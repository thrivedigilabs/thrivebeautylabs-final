...
const SHOPIFY_STORE_PERMANENT_DOMAIN = 'thrive-beauty-labs-3i450.myshopify.com';
const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
const SHOPIFY_STOREFRONT_TOKEN = 'c3d23898873af26e2b9ce2d5a8e26a8a';
...
export async function fetchProducts(first = 10, query?: string): Promise<ShopifyProduct[]> {
